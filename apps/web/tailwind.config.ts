  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        pulseDot: {
          '0%, 100%': { boxShadow: '0 0 0 0 rgba(0,184,150,0.38)' },
          '50%': { boxShadow: '0 0 0 6px rgba(0,184,150,0)' },
        },
        floatUp: {
      ...
      backgroundImage: {
        'grid-pattern': `linear-gradient(rgba(0,184,150,0.02) 1px, transparent 1px),
          linear-gradient(90deg, rgba(0,184,150,0.02) 1px, transparent 1px)`,
